...
CMD="--create --if-not-exists --bootstrap-server kafka4:9092,kafka4:9092,kafka6:9092 --command-config /tmp/root.properties --replication-factor $REPLICATION --partitions $PARTITIONS --topic $KAFKA_TOPIC"
